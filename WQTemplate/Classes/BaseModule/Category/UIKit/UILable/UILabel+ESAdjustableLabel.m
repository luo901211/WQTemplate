                 ...
                 minimumFontSize:(int)minFontSize
{
  ...
  do {
    ...
    calculatedSizeWithCurrentFontSize = [[self text] boundingRectWithSize:unconstrainedSize options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil].size;
