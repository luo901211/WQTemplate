...
+ (void)getWithPath:(NSString *)path
    ...
    [[AFHttpClient sharedClient] GET:[url stringByAppendingString:@"/"] parameters:params progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
